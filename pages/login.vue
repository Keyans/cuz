      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <form class="space-y-6" @submit.prevent="login">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <NuxtLink to="/forgot-password" class="font-medium text-primary hover:text-secondary">
                Forgot password?
              </NuxtLink>
            </div>
          </div>
...
const loginWithDemoAccount = async () => {
  ...
  try {
    ...
    error.value = err.message || 'Failed to login with demo account. Please try again.'
  } finally {
    loading.value = false
  }
}
